...
class sale_delivery_price_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(sale_delivery_price_report, self).__init__(cr, uid, name, context=context)
...
class report_sale_delivery_ext(osv.AbstractModel):
    _name = 'report.smt_delivery_report.delivery_report_price_ext'
    _inherit = 'report.abstract_report'
    _template = 'smt_delivery_report.delivery_report_price_ext'
    _wrapped_report_class = sale_delivery_price_report
